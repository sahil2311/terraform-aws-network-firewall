resource "aws_route" "aws_route" {
  depends_on             = [aws_route_table.aws_route_table_public, aws_subnet.aws_subnet_public, aws_subnet.aws_subnet_inspection, aws_ec2_transit_gateway.aws_ec2_transit_gateway]
